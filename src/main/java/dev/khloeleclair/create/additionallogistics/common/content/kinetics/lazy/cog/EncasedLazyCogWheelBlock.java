...
public class EncasedLazyCogWheelBlock extends LazyCogWheelBlock implements SpecialBlockItemRequirement, EncasedBlock {
    ...
    public EncasedLazyCogWheelBlock(boolean large, Properties properties, Supplier<Block> casing) {
        super(large, properties);
        this.casing = casing;
    }

    public static EncasedLazyCogWheelBlock small(Properties properties, Supplier<Block> casing) {
        return new EncasedLazyCogWheelBlock(false, properties, casing);
    }

    public static EncasedLazyCogWheelBlock large(Properties properties, Supplier<Block> casing) {
    ...
    public InteractionResult onSneakWrenched(BlockState state, UseOnContext context) {
        ...
        KineticBlockEntity.switchToBlockState(context.getLevel(), context.getClickedPos(),
                copyValuesForCasing(state, getLazyCog().getDefaultState()));
    ...
    public BlockEntry<?> getLazyCog() {
        return isLarge ? CALBlocks.LAZY_LARGE_COGWHEEL : CALBlocks.LAZY_COGWHEEL;
    }

    @Override
    public ItemRequirement getRequiredItems(BlockState state, @Nullable BlockEntity blockEntity) {
        return ItemRequirement.of(getLazyCog().getDefaultState(), blockEntity);
    }
