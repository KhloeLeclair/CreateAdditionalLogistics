...
public enum CALGuiTextures implements ScreenElement, TextureSheetSegment {
    ...
    PROMISE_LIMIT_BG("promise_limit", 72, 28)
    ...
    CALGuiTextures(String location, int startX, int startY, int width, int height) {
        this(CreateAdditionalLogistics.MODID, location, startX, startY, width, height);
    }

    CALGuiTextures(String namespace, String location, int startX, int startY, int width, int height) {
